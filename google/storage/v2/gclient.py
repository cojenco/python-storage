...
class StorageClient(metaclass=StorageClientMeta):
    ...
    def delete_bucket(self,
        ...
        Args:
            request (Union[google.storage_v2.types.DeleteBucketRequest, dict]):
    ...
    def get_bucket(self,
        ...
        Args:
            request (Union[google.storage_v2.types.GetBucketRequest, dict]):
        ...
        Returns:
            google.storage_v2.types.Bucket:
                A bucket.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
    ...
    def create_bucket(self,
        ...
        Args:
            request (Union[google.storage_v2.types.CreateBucketRequest, dict]):
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            bucket (google.storage_v2.types.Bucket):
    ...
    def list_buckets(self,
        ...
        Args:
            request (Union[google.storage_v2.types.ListBucketsRequest, dict]):
        ...
        Returns:
            google.storage_v2.services.storage.pagers.ListBucketsPager:
    ...
    def lock_bucket_retention_policy(self,
        ...
        Args:
            request (Union[google.storage_v2.types.LockBucketRetentionPolicyRequest, dict]):
    ...
    def update_bucket(self,
        ...
        Args:
            request (Union[google.storage_v2.types.UpdateBucketRequest, dict]):
    ...
    def compose_object(self,
        ...
        Args:
            request (Union[google.storage_v2.types.ComposeObjectRequest, dict]):
    ...
    def delete_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Union[google.storage_v2.types.DeleteObjectRequest, dict]):
    ...
    def restore_object(self,
        ...
        Args:
            request (Union[google.storage_v2.types.RestoreObjectRequest, dict]):
    ...
    def cancel_resumable_write(self,
        ...
        Args:
            request (Union[google.storage_v2.types.CancelResumableWriteRequest, dict]):
        ...
        Returns:
            google.storage_v2.types.CancelResumableWriteResponse:
    ...
    def get_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Union[google.storage_v2.types.GetObjectRequest, dict]):
    ...
    def bidi_read_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            requests (Iterator[google.storage_v2.types.BidiReadObjectRequest]):
        ...
        Returns:
            Iterable[google.storage_v2.types.BidiReadObjectResponse]:
    ...
    def update_object(self,
        ...
        Args:
            request (Union[google.storage_v2.types.UpdateObjectRequest, dict]):
                The request object. Request message for UpdateObject.
            object_ (google.storage_v2.types.Object):
    ...
    def bidi_write_object(self,
        ...
        Args:
            requests (Iterator[google.storage_v2.types.BidiWriteObjectRequest]):
        ...
        Returns:
            Iterable[google.storage_v2.types.BidiWriteObjectResponse]:
    ...
    def list_objects(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Union[google.storage_v2.types.ListObjectsRequest, dict]):
        ...
        Returns:
            google.storage_v2.services.storage.pagers.ListObjectsPager:
                The result of a call to
                Objects.ListObjects
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def rewrite_object(self,
        ...
        Args:
            request (Union[google.storage_v2.types.RewriteObjectRequest, dict]):
        ...
        Returns:
            google.storage_v2.types.RewriteResponse:
                A rewrite response.
        """
        # Create or coerce a protobuf request object.
        # - Use the request object if provided (there's no risk of modifying the input as
    ...
    def move_object(self,
        ...
        Args:
            request (Union[google.storage_v2.types.MoveObjectRequest, dict]):
